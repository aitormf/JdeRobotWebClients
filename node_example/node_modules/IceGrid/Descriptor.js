...
(function(global, r)
{
    ...
    Slice.defineDictionary(IceGrid, "StringStringDict", "StringStringDictHelper", "Ice.StringHelper", "Ice.StringHelper", false, false);
    ...
    IceGrid.PropertySetDescriptor = Slice.defineStruct(
        ...
        2, 
        false);
    Slice.defineDictionary(IceGrid, "PropertySetDescriptorDict", "PropertySetDescriptorDictHelper", "Ice.StringHelper", "IceGrid.PropertySetDescriptor", false, false);
    ...
    IceGrid.ObjectDescriptor = Slice.defineStruct(
        function(id, type, proxyOptions)
        {
            ...
            this.proxyOptions = proxyOptions !== undefined ? proxyOptions : null;
        },
        true,
        function(__os)
        {
        ...
        function(__is)
        {
            this.id = Ice.Identity.read(__is);
    ...
    IceGrid.AdapterDescriptor = Slice.defineStruct(
        function(name, description, id, replicaGroupId, priority, registerProcess, serverLifetime, objects, allocatables)
        {
            ...
            this.id = id !== undefined ? id : null;
            this.replicaGroupId = replicaGroupId !== undefined ? replicaGroupId : null;
    ...
    IceGrid.DbEnvDescriptor = Slice.defineStruct(
        function(name, description, dbHome, properties)
        {
            this.name = name !== undefined ? name : null;
            this.description = description !== undefined ? description : null;
            this.dbHome = dbHome !== undefined ? dbHome : null;
            this.properties = properties !== undefined ? properties : null;
        },
        true,
        function(__os)
    ...
    IceGrid.CommunicatorDescriptor = Slice.defineObject(
        function(adapters, propertySet, dbEnvs, logs, description)
        {
            ...
            this.propertySet = propertySet !== undefined ? propertySet : null;
        ...
        function(__is)
        {
            ...
            this.propertySet = IceGrid.PropertySetDescriptor.read(__is);
    ...
    IceGrid.DistributionDescriptor = Slice.defineStruct(
        ...
        {
            this.icepatch = icepatch !== undefined ? icepatch : null;
    ...
    IceGrid.ServerDescriptor = Slice.defineObject(
        function(adapters, propertySet, dbEnvs, logs, description, id, exe, iceVersion, pwd, options, envs, activation, activationTimeout, deactivationTimeout, applicationDistrib, distrib, allocatable, user)
        {
            ...
            this.id = id !== undefined ? id : null;
            this.exe = exe !== undefined ? exe : null;
            this.iceVersion = iceVersion !== undefined ? iceVersion : null;
            this.pwd = pwd !== undefined ? pwd : null;
            this.options = options !== undefined ? options : null;
            this.envs = envs !== undefined ? envs : null;
            this.activation = activation !== undefined ? activation : null;
            this.activationTimeout = activationTimeout !== undefined ? activationTimeout : null;
            this.deactivationTimeout = deactivationTimeout !== undefined ? deactivationTimeout : null;
        ...
        function(__is)
        {
            ...
            this.distrib = IceGrid.DistributionDescriptor.read(__is);
    ...
    IceGrid.ServiceDescriptor = Slice.defineObject(
        function(adapters, propertySet, dbEnvs, logs, description, name, entry)
        {
            IceGrid.CommunicatorDescriptor.call(this, adapters, propertySet, dbEnvs, logs, description);
            this.name = name !== undefined ? name : null;
            this.entry = entry !== undefined ? entry : null;
        },
        IceGrid.CommunicatorDescriptor, undefined, 2,
        [
            "::Ice::Object",
    ...
    IceGrid.ServerInstanceDescriptor = Slice.defineStruct(
        ...
        {
            this.template = template !== undefined ? template : null;
    ...
    IceGrid.TemplateDescriptor = Slice.defineStruct(
        ...
        3, 
        false);
    Slice.defineDictionary(IceGrid, "TemplateDescriptorDict", "TemplateDescriptorDictHelper", "Ice.StringHelper", "IceGrid.TemplateDescriptor", false, false);
    ...
    IceGrid.NodeDescriptor = Slice.defineStruct(
        ...
        6, 
        false);
    Slice.defineDictionary(IceGrid, "NodeDescriptorDict", "NodeDescriptorDictHelper", "Ice.StringHelper", "IceGrid.NodeDescriptor", false, false);
    ...
    IceGrid.LoadBalancingPolicy = Slice.defineObject(
        ...
        {
            Ice.Object.call(this);
            this.nReplicas = nReplicas !== undefined ? nReplicas : null;
        },
        Ice.Object, undefined, 1,
        [
            "::Ice::Object",
    ...
    IceGrid.AdaptiveLoadBalancingPolicy = Slice.defineObject(
        ...
        {
            IceGrid.LoadBalancingPolicy.call(this, nReplicas);
            this.loadSample = loadSample !== undefined ? loadSample : null;
        },
    ...
    IceGrid.ReplicaGroupDescriptor = Slice.defineStruct(
        function(id, loadBalancing, proxyOptions, objects, description)
        {
            this.id = id !== undefined ? id : null;
    ...
    IceGrid.BoxedDistributionDescriptor = Slice.defineObject(
        ...
        function(__is)
        {
            this.value = IceGrid.DistributionDescriptor.read(__is);
        },
        false);
