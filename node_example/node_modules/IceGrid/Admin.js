...
(function(global, r)
{
    ...
    Slice.defineDictionary(IceGrid, "StringObjectProxyDict", "StringObjectProxyDictHelper", "Ice.StringHelper", "Ice.ObjectPrx", false, false);
    ...
    IceGrid.ServerInfo = Slice.defineStruct(
        ...
        {
            this.application = application !== undefined ? application : null;
            ...
            this.sessionId = sessionId !== undefined ? sessionId : null;
        },
        false,
        function(__os)
        {
    ...
    IceGrid.NodeInfo = Slice.defineStruct(
        function(name, os, hostname, release, version, machine, nProcessors, dataDir)
        {
            ...
            this.os = os !== undefined ? os : null;
            this.hostname = hostname !== undefined ? hostname : null;
            this.release = release !== undefined ? release : null;
            this.version = version !== undefined ? version : null;
            this.machine = machine !== undefined ? machine : null;
            this.nProcessors = nProcessors !== undefined ? nProcessors : 0;
            this.dataDir = dataDir !== undefined ? dataDir : null;
        },
        true,
        function(__os)
        {
    ...
    IceGrid.ApplicationInfo = Slice.defineStruct(
        function(uuid, createTime, createUser, updateTime, updateUser, revision, descriptor)
        {
            ...
            this.createUser = createUser !== undefined ? createUser : null;
            this.updateTime = updateTime !== undefined ? updateTime : 0;
            this.updateUser = updateUser !== undefined ? updateUser : null;
            this.revision = revision !== undefined ? revision : 0;
            this.descriptor = descriptor !== undefined ? descriptor : null;
        },
        false,
        ...
        function(__is)
        {
            ...
            this.revision = __is.readInt();
            this.descriptor = IceGrid.ApplicationDescriptor.read(__is);
        },
        33, 
        false);
    ...
    IceGrid.ApplicationUpdateInfo = Slice.defineStruct(
        ...
        function(__is)
        {
            ...
            this.updateUser = __is.readString();
            this.revision = __is.readInt();
            this.descriptor = IceGrid.ApplicationUpdateDescriptor.read(__is);
        },
        28, 
        false);
