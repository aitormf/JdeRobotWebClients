...
(function(global, r)
{
    ...
    Slice.defineDictionary(IceMX, "StringIntDict", "StringIntDictHelper", "Ice.StringHelper", "Ice.IntHelper", false, false);
    ...
    Slice.defineDictionary(IceMX, "MetricsView", "MetricsViewHelper", "Ice.StringHelper", "IceMX.MetricsMapHelper", false, false);
    ...
    IceMX.RemoteMetricsPrx = Slice.defineProxy(IceMX.MetricsPrx, IceMX.RemoteMetrics.ice_staticId, undefined);
    ...
    IceMX.InvocationMetrics = Slice.defineObject(
        function(id, total, current, totalLifetime, failures, retry, userException, remotes)
        {
            IceMX.Metrics.call(this, id, total, current, totalLifetime, failures);
